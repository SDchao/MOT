...
from windows.multi_target_widget import MultiTargetWidget
...
multi_widget = MultiTargetWidget()
main_window = MainWindow(multi_widget)
...
multi_widget.set_reid_container(reid_container)
